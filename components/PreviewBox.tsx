  ...
  return (
    <div className="space-y-8 w-full">
      ...
      <div className="relative">
        <div className="w-full min-h-[200px] p-6 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 animate-fade-up [animation-delay:200ms]">
        ...
        {/* Copy Button */}
        <div className="flex justify-end mt-3 opacity-0 animate-fade-up [animation-delay:400ms]">
          <button
            onClick={handleCopy}
